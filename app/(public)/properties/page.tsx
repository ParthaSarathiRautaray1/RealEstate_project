  ...
  return (
    <main className="container py-8 sm:py-10">
      <div className="mb-8">
        ...
        <h1 className="mt-2 font-serif text-4xl font-semibold sm:text-5xl">Find the right address</h1>
        <div className="mt-6"><SearchBar defaultQuery={params.q} defaultType={params.type} /></div>
        <form className="mt-4 flex justify-start sm:justify-end">
      ...
      <div className="grid gap-8 lg:grid-cols-[minmax(0,1fr)_380px]">
        ...
        <aside className="h-[320px] overflow-hidden rounded-lg border sm:h-[420px] lg:sticky lg:top-24 lg:h-[520px]">{sorted.length ? <DynamicPropertyMap properties={sorted} /> : null}</aside>
      </div>
    </main>
  );
}
